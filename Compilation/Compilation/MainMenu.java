    ...
    do {
        ...
        switch (choice) {
            case "1":
                ...
                // Check if the expression is well-defined
                if (!expressionChecker.isWellDefined(infix)) {
                    System.out.println("The expression is not well-defined. Please check your expression.");
                } else {
                ...
                case "1":
                    ...
                    while (true) {
                        try {
                            n = Integer.parseInt(scan.nextLine());
                            if (n <= 0) {
                                System.out.println("Invalid size. Default size of 10 will be used.");
                                n = 10;
                            }
